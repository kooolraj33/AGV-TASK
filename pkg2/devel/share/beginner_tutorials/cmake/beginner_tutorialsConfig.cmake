...
if("TRUE" STREQUAL "TRUE")
  set(beginner_tutorials_SOURCE_PREFIX /home/pavangopalrayapati/pkg1/pkg2)
  set(beginner_tutorials_DEVEL_PREFIX /home/pavangopalrayapati/pkg1/pkg2/devel)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'raj <kooolraj34@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pavangopalrayapati/pkg1/pkg2/${idir}'.  Ask the maintainer 'raj <kooolraj34@gmail.com>' to fix it.")
    endif()
